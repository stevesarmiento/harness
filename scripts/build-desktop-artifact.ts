...
// Fork: Forma public-config validation for release builds.
import {
...
export const DESKTOP_FILE_EXCLUSIONS = [
  ...
  // Fork: selectable app icons ship as real files via extraResources — the dock
  // and window icon APIs need real paths — so keep the staged copy out of the asar.
  ...
  if (platform === "linux") {
    buildConfig.linux = {
      ...
      protocols: [
        {
          name: "Forma",
          // Fork: rebrand — forma:// registered alongside t3code:// (the
          // server's allowed desktop origins are hardcoded upstream).
          schemes: ["forma", "forma-dev", "t3code", "t3code-dev"],
        },
      ],
      desktop: {
