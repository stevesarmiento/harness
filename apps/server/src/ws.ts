...
// Fork: thread extensions (thread forking, interaction-mode bookkeeping)
...
const makeWsRpcLayer = (
  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      // Fork: project-local agent skills inventory.
      ...
      return WsRpcGroup.of({
          ...
          observeRpcEffect(
            ...
            Effect.gen(function* () {
              ...
              if (normalizedCommand.type === "thread.turn.start") {
                // Fork: best-effort bookkeeping — interaction-mode extension state must never
        ...
        // Fork: component preview harness RPC methods.
