...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.projectsLocalAgentInventory]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.componentPreviewInspectProject]: AuthOrchestrationReadScope,
  [WS_METHODS.componentPreviewSearchComponents]: AuthOrchestrationReadScope,
  [WS_METHODS.componentPreviewResolveTarget]: AuthOrchestrationOperateScope,
  [WS_METHODS.componentPreviewPrepareBootstrapThread]: AuthOrchestrationOperateScope,
  [WS_METHODS.componentPreviewPrepareGenerationTurn]: AuthOrchestrationOperateScope,
  [WS_METHODS.componentPreviewPrepareRepairTurn]: AuthOrchestrationOperateScope,
  [WS_METHODS.componentPreviewEnsureRuntime]: AuthOrchestrationOperateScope,
  [WS_METHODS.componentPreviewIssueAccessToken]: AuthOrchestrationOperateScope,
  [WS_METHODS.componentPreviewStopRuntime]: AuthOrchestrationOperateScope,
  [WS_METHODS.subscribeComponentPreviewProject]: AuthOrchestrationReadScope,
  [WS_METHODS.threadExtensionsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.threadExtensionsSetInteractionMode]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadExtensionsEnqueueTurn]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadExtensionsRemoveQueuedTurn]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadExtensionsResumeQueue]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadExtensionsFork]: AuthOrchestrationOperateScope,
  [WS_METHODS.subscribeThreadExtensions]: AuthOrchestrationReadScope,
