                ...
                >
                  {topStatus ? (
                    isWokeStatus ? (
                      ...
                      >
                        {/* Fork: legacy Forma status glyphs in the v2 slot. */}
                        {topStatus.icon === "grid" ? (
                          <span
                            aria-hidden
        ...
        fixedHeader={
          ...
          <SidebarGroup className="relative z-[1] gap-1 p-[var(--sidebar-content-inset)]">
            <div className="flex items-center gap-1">
              {/* Fork: search styled like the legacy sidebar's command trigger:
                  bordered rounded pill on the accent surface. */}
              <div className="flex h-9 min-w-0 flex-1 items-center gap-2 rounded-xl border border-border/60 bg-accent/70 px-2.5 py-1.5 text-muted-foreground/70 shadow-sm/5 transition-colors focus-within:border-border hover:bg-accent/85 hover:text-foreground">
                  ...
                  >
                    <div className="shrink-0 px-3 pt-2.5">
                      <div className="relative -translate-y-px border-b border-border/70 pb-1.5 transition-colors focus-within:border-ring">
                        <SearchIcon
                          aria-hidden="true"
                          className="pointer-events-none absolute top-1.5 left-0 size-4 shrink-0 fill-current text-muted-foreground/55"
                        />
                        <ComboboxInput
