...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    title: "Contrast",
    // Fork: grafted into the Interface page's Display section.
  ...
  },
  {
    ...
    // Fork: rendered by TypographySection on the Interface page.
    to: "/settings/interface",
  ...
  },
  {
    ...
    // Fork: grafted into the Advanced page's Updates section.
  ...
  },
  {
    ...
    // Fork: grafted into the Threads page's Safety & cleanup section.
    to: "/settings/threads",
  ...
  },
  {
    ...
    title: "Quit shortcut",
    // Fork: grafted into the Advanced page's Desktop section.
    to: "/settings/advanced",
  ...
  },
  {
    ...
    // Fork: legacy features live on the Advanced page.
    to: "/settings/advanced",
  ...
  // Fork: Forma sections. (A separate "font size and smoothing" alias was
  // dropped once the typography rows above pointed directly at Interface.)
