...
/**
 * Stroke-draw animated Forma logomark — same paths and draw choreography as
 * the boot splash in index.html. Styles live in the Forma section of
 * index.css (`.forma-logomark-animated`).
 */
export function LogomarkFormaAnimated({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      aria-label="Forma"
      className={cn("forma-logomark-animated", className)}
      fill="none"
      role="img"
      viewBox="0 0 432 489"
    ...
    >
      <title>Forma</title>
      <path
        className="forma-logomark-animated-path-1"
      ...
      />
      <path
        className="forma-logomark-animated-path-2"
      ...
      />
      <path
        className="forma-logomark-animated-path-3"
