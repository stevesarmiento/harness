...
// Fork: versioned project-file saves.
...
// Fork: add-selection-to-chat code context.
...
> & {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      {/* Fork: versioned-save conflict banner. */}
      {saveState.conflict ? (
        <FileVersionConflictBanner
          onReloadFromDisk={() => {
            saveState.reloadFromDisk();
...
export default function FilePreviewPanel({
  ...
  // Fork: bump to remount the rendered-markdown surface after a reload-from-disk.
  ...
  // Fork: versioned-save conflict recovery.
